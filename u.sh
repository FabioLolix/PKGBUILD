...
VAR2=d
  ...
  cd "$BASE/$VAR"
    makepkg --printsrcinfo > .SRCINFO
    cp -a {PKGBUILD,.SRCINFO,*.install} "$DEST/$VAR2/$VAR"
    echo "    synced $VAR"

  VAR=dvdisaster-speed47
  cd "$BASE/$VAR"
    makepkg --printsrcinfo > .SRCINFO
    cp -a {PKGBUILD,.SRCINFO} "$DEST/$VAR2/$VAR"
    echo "    synced $VAR"

  VAR=dvdisaster-speed47-git
  cd "$BASE/$VAR"
    makepkg --printsrcinfo > .SRCINFO
    cp -a {PKGBUILD,.SRCINFO} "$DEST/$VAR2/$VAR"
    echo "    synced $VAR"
...
VAR2=g
  ...
  cd "$BASE/$VAR"
    makepkg --printsrcinfo > .SRCINFO
    cp -a {PKGBUILD,.SRCINFO,cargo} "$DEST/$VAR2/$VAR"
    echo "    synced $VAR"
...
VAR2=l
  ...
  cd "$BASE/$VAR"
    makepkg --printsrcinfo > .SRCINFO
    cp -a {PKGBUILD,.SRCINFO,*.service,*.install} "$DEST/$VAR2/$VAR"
    echo "    synced $VAR"
...
VAR2=m
  ...
  cd "$BASE/$VAR"
    makepkg --printsrcinfo > .SRCINFO
    cp -a {PKGBUILD,.SRCINFO,mpd.conf,mpd.sysusers,mpd.tmpfiles} "$DEST/$VAR2/$VAR"
    echo "    synced $VAR"
...
VAR2=s
  ...
  cd "$BASE/$VAR"
    makepkg --printsrcinfo > .SRCINFO
    cp -a {PKGBUILD,.SRCINFO,conffile,*.install,*.service} "$DEST/$VAR2/$VAR"
    echo "    synced $VAR"
